...
public class AndroidSQLiteDatabase implements SQLiteDatabase {
   ...
   */
  public AndroidSQLiteDatabase(String dbQname, long timeout, long retryInterval, int flags) throws SQLException {
    super();
   ...
   */
  @Override
public SQLiteCursor rawQuery(String sql, String[] makeArgListQueryString) throws SQLException {
...
public void close() throws SQLException {
  ...
  public int changedRowCount () {
    ...
    public SQLiteCursor mergeCursors(SQLiteCursor[] cursors) {
        return new AndroidSQLiteMergedCursors(cursors);
    }

    @Override
    public SQLiteMatrixCursor createCursor(String[] columnNames, int count) {
        return new AndroidSQLiteMatrixCursor(columnNames, count);
    }
